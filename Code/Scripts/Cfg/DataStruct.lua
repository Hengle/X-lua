...
meta= {}
meta.__index = meta
meta.class = 'Csv.Skill.ActorConfig'
GetOrCreate('Csv.Skill')['ActorConfig'] = meta
function Stream:GetCsvSkillActorConfig()
	local o = {}
	setmetatable(o, Csv.Skill.ActorConfig)
	o.ModelName = self:GetString()
	o.GroupType = self:GetInt()
	o.BaseModelName = self:GetString()
	o.GeneralActions = self:GetList('CsvSkillGeneralAction')
	o.SkillActions = self:GetList('CsvSkillSkillAction')
	return o
end
meta= {}
meta.__index = meta
meta.class = 'Csv.Skill.GeneralAction'
GetOrCreate('Csv.Skill')['GeneralAction'] = meta
function Stream:GetCsvSkillGeneralAction()
	local o = {}
	setmetatable(o, Csv.Skill.GeneralAction)
	...
	o.Actions = self:GetList('CsvSkillAction')
	o.Effects = self:GetList('CsvSkillEffectGroup')
	return o
end
meta= {}
meta.__index = meta
...
function Stream:GetCsvSkillSkillAction()
	...
	o.HitPoints = self:GetList('CsvSkillHitPointGroup')
	o.HitZones = self:GetList('CsvSkillHitZone')
	o.BeAttackEffects = self:GetList('CsvSkillBeAttackEffect')
	return o
end
meta= {}
meta.__index = meta
...
function Stream:GetCsvSkillHitPointGroup()
	...
	o.Id = self:GetInt()
	o.Name = self:GetString()
	o.Attacks = self:GetList('CsvSkillAttack')
	return o
end
meta= {}
meta.__index = meta
...
GetOrCreate('Csv.Skill')['GroupType'] = {
	NULL = -9,
	None = 0,
	Base = 1,
	Player = 2,
