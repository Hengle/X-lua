...
namespace XLua.CSObjectWrap
{
    ...
    public class GameUtilWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 13, 4, 0);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ReadDict", _m_ReadDict_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ReadList", _m_ReadList_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "WriteDict", _m_WriteDict_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "WriteList", _m_WriteList_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ReadDict_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _filePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        System.Collections.Generic.Dictionary<string, string> gen_ret = Game.Util.ReadDict( _filePath );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ReadList_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _filePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        System.Collections.Generic.List<string> gen_ret = Game.Util.ReadList( _filePath );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WriteDict_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _filePath = LuaAPI.lua_tostring(L, 1);
                    System.Collections.Generic.Dictionary<string, string> _dict = (System.Collections.Generic.Dictionary<string, string>)translator.GetObject(L, 2, typeof(System.Collections.Generic.Dictionary<string, string>));
                    
                    Game.Util.WriteDict( _filePath, _dict );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WriteList_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Game.Util.WriteList( _filePath, _list );
