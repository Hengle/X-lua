...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGraphicsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 19, 4, 1);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "CreateGPUFence", _m_CreateGPUFence_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "WaitOnGPUFence", _m_WaitOnGPUFence_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CreateGPUFence_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        UnityEngine.Rendering.GPUFence gen_ret = UnityEngine.Graphics.CreateGPUFence(  );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Rendering.SynchronisationStage>(L, 1)) 
                {
                    UnityEngine.Rendering.SynchronisationStage _stage;translator.Get(L, 1, out _stage);
                        ...
                        UnityEngine.Rendering.GPUFence gen_ret = UnityEngine.Graphics.CreateGPUFence( _stage );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Graphics.CreateGPUFence!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WaitOnGPUFence_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Rendering.GPUFence>(L, 1)) 
                {
                    UnityEngine.Rendering.GPUFence _fence;translator.Get(L, 1, out _fence);
                    
                    UnityEngine.Graphics.WaitOnGPUFence( _fence );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Rendering.GPUFence>(L, 1)&& translator.Assignable<UnityEngine.Rendering.SynchronisationStage>(L, 2)) 
                {
                    UnityEngine.Rendering.GPUFence _fence;translator.Get(L, 1, out _fence);
                    UnityEngine.Rendering.SynchronisationStage _stage;translator.Get(L, 2, out _stage);
                    
                    UnityEngine.Graphics.WaitOnGPUFence( _fence, _stage );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Graphics.WaitOnGPUFence!");
        ...
        static int _m_DrawProcedural_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.MeshTopology>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    UnityEngine.Graphics.DrawProcedural( _topology, _vertexCount );
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.MeshTopology>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    UnityEngine.Graphics.DrawProcedural( _topology, _vertexCount, _instanceCount );
        ...
        static int _m_DrawProceduralIndirect_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.MeshTopology>(L, 1)&& translator.Assignable<UnityEngine.ComputeBuffer>(L, 2)) 
                {
                    ...
                    UnityEngine.Graphics.DrawProceduralIndirect( _topology, _bufferWithArgs );
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.MeshTopology>(L, 1)&& translator.Assignable<UnityEngine.ComputeBuffer>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    UnityEngine.Graphics.DrawProceduralIndirect( _topology, _bufferWithArgs, _argsOffset );
