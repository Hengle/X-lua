...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp3(System.IAsyncResult p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp6()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(UnityEngine.AsyncOperation p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(UnityEngine.RectTransform p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp11(UnityEngine.Object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(FairyGUI.EventContext p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp13(FairyGUI.UIPackage p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public InvokeLua.ICalc __Gen_Delegate_Imp15(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp16(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp17(UnityEngine.Vector3 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaTest.MyStruct __Gen_Delegate_Imp18(XLuaTest.MyStruct p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaTest.MyEnum __Gen_Delegate_Imp19(XLuaTest.MyEnum p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public decimal __Gen_Delegate_Imp20(decimal p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp21(System.Array p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.AsyncCallback(__Gen_Delegate_Imp3);
			}
			...
			{
			    return new System.Func<bool>(__Gen_Delegate_Imp6);
			}
			...
			{
			    return new System.Action<UnityEngine.AsyncOperation>(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(UnityEngine.RectTransform.ReapplyDrivenProperties))
			{
			    return new UnityEngine.RectTransform.ReapplyDrivenProperties(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Object>))
			{
			    return new System.Action<UnityEngine.Object>(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(FairyGUI.EventCallback1))
			{
			    return new FairyGUI.EventCallback1(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(System.Action<FairyGUI.UIPackage>))
			{
			    return new System.Action<FairyGUI.UIPackage>(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(FairyGUI.TimerCallback))
			{
			    return new FairyGUI.TimerCallback(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(InvokeLua.CalcNew))
			{
			    return new InvokeLua.CalcNew(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(XLuaTest.IntParam))
			{
			    return new XLuaTest.IntParam(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(XLuaTest.Vector3Param))
			{
			    return new XLuaTest.Vector3Param(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(XLuaTest.CustomValueTypeParam))
			{
			    return new XLuaTest.CustomValueTypeParam(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(XLuaTest.EnumParam))
			{
			    return new XLuaTest.EnumParam(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(XLuaTest.DecimalParam))
			{
			    return new XLuaTest.DecimalParam(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(XLuaTest.ArrayAccess))
			{
			    return new XLuaTest.ArrayAccess(__Gen_Delegate_Imp21);
			}
