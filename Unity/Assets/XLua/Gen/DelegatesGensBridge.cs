...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(System.IAsyncResult p0)
		{
		...
		public void __Gen_Delegate_Imp2(string p0, bool p1, string p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp3(string p0, string p1, UnityEngine.LogType p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp6(UnityEngine.AsyncOperation p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(UnityEngine.RectTransform p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(UnityEngine.Object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.AsyncCallback(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(Game.LateUpdateFunc))
			{
			    return new Game.LateUpdateFunc(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(UnityEngine.Application.AdvertisingIdentifierCallback))
			{
			    return new UnityEngine.Application.AdvertisingIdentifierCallback(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(UnityEngine.Application.LogCallback))
			{
			    return new UnityEngine.Application.LogCallback(__Gen_Delegate_Imp3);
			}
			...
			{
			    return new System.Action<UnityEngine.AsyncOperation>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(UnityEngine.RectTransform.ReapplyDrivenProperties))
			{
			    return new UnityEngine.RectTransform.ReapplyDrivenProperties(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Object>))
			{
			    return new System.Action<UnityEngine.Object>(__Gen_Delegate_Imp8);
			}
		    ...
		    if (type == typeof(Game.UpdateFunc))
			{
			    return new Game.UpdateFunc(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(Game.FixedUpdateFunc))
			{
			    return new Game.FixedUpdateFunc(__Gen_Delegate_Imp18);
			}
