...
{
	public  class SkillAction : XmlCode.Skill.GeneralAction
	{
		/// <summary>
		...
		/// <summary>
		public XmlCode.Skill.LockObjectType LockType;
		/// <summary>
		/// 技能作用范围[半径]
		/// <summary>
		...
		public override void Read(XmlNode _1)
		{
			...
			switch (_2.Name)
			{
				...
				case "LockType": this.LockType = (XmlCode.Skill.LockObjectType)ReadInt(_2); break;
