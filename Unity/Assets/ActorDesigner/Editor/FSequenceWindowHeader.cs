...
namespace FluxEditor
{
    public class FSequenceWindowHeader
    {
        ...
        private const float EXECUTETIME_FIELD_WIDTH = 60;
        ...
        private SerializedProperty _sequenceExecuteTime;
        ...
        private GUIContent _executeTimeLabel = new GUIContent("执行次数", "小于0时,为无限循环;反之执行指定次数.");
        private Rect _executeTimeLabelRect;
        private Rect _executeTimeFieldRect;
        private bool _showExecuteTime;
        ...
        public void RebuildLayout(Rect rect)
        {
            ...
            _executeTimeLabelRect = _executeTimeFieldRect = rect;

            _executeTimeLabelRect.width = EditorStyles.label.CalcSize(_executeTimeLabel).x + LABEL_SPACE;
            _executeTimeFieldRect.width = EXECUTETIME_FIELD_WIDTH;
            ...
            _executeTimeFieldRect.x = _updateModeLabelRect.xMin - ELEMENT_SPACE - _executeTimeFieldRect.width;
            _executeTimeLabelRect.x = _executeTimeFieldRect.xMin - _executeTimeLabelRect.width;

            reminderWidth -= (_executeTimeLabelRect.width + _executeTimeFieldRect.width + ELEMENT_SPACE);

            _showExecuteTime = reminderWidth >= 0;
