...
namespace FluxEditor
{
    public class FTrackEditor : FEditor
    {
        ...
        {
            Undo.RecordObjects(new UnityEngine.Object[] { ContainerEditor, Track.Container }, string.Empty);
            GameObject duplicateTrack = (GameObject)Instantiate(Track.gameObject);
            duplicateTrack.name = Track.gameObject.name;
            Undo.SetTransformParent(duplicateTrack.transform, Track.Container.transform, string.Empty);
