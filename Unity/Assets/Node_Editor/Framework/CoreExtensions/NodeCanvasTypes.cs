...
namespace NodeEditorFramework
{
    public class NodeCanvasManager
    {
        ...
        public static void InitSystem(out Dictionary<Type, NodeCanvasTypeData> types)
        {
            types = new Dictionary<Type, NodeCanvasTypeData>();
            foreach (Type type in ReflectionUtility.getSubTypes(typeof(NodeCanvas), typeof(NodeCanvasTypeAttribute)))
            {
                ...
                types.Add(type, new NodeCanvasTypeData() { CanvasType = type, DisplayString = attr.Name });
            }
            CanvasTypes = types;
        }
        ...
        //{
        //    CanvasTypes = NodeSystemSetting.Inst.CanvasDatas;
        //}
